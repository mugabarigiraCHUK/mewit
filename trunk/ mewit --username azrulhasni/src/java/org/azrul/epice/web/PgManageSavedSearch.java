 ...
 */
public class PgManageSavedSearch extends AbstractPageBean {
    ...
    private Table tbSaveSearch = new Table();

    public Table getTbSaveSearch() {
        return tbSaveSearch;
    }

    public void setTbSaveSearch(Table t) {
        this.tbSaveSearch = t;
    }
    private TableRowGroup trgSavedSearch = new TableRowGroup();

    public TableRowGroup getTrgSavedSearch() {
        return trgSavedSearch;
    }

    public void setTrgSavedSearch(TableRowGroup trg) {
        this.trgSavedSearch = trg;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("PgManageSaveSearch Initialization Failure", e);
    ...
    public String button2_action() {
        ...
        getSessionBean1().refreshSearchItemsQueryDP(searchItemsQueryDAO.runItemsQueryQuery(getSessionBean1().getCurrentUser(),getSessionBean1().getSearchItemsQueryQuery()));
        getSessionBean1().setPreviousPage("PgManageSavedSearch");
        return "gotoSearch";
    }
