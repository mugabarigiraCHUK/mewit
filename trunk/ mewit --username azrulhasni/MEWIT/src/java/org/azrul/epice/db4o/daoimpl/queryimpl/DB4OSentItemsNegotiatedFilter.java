 ...
 */
public class DB4OSentItemsNegotiatedFilter implements DB4OItemsFilter{
    ...
    public DB4OSentItemsNegotiatedFilter(){
        type = "SENT_ITEMS_NEGOTIATED";
    }
     ...
     public boolean booleanFilter(Item item, String user) {
        return (item.getDeadLine() != null && item.getSender().equals(user) && item.getStatus().equals(Item.Status.NEGOTIATED));
    }
}
