...
public class ReportUtil {
    ...
    public static String itemsToCSV(List<Item> items,String user) {
...
//        str.append("REASON_FOR_NEGOTIATION,");
        ...
        for (Item i : items) {
            ...
            //received item
            if (i.getRecipients().contains(user)) {
                itemTypeState = 2;
            } else {
                itemTypeState = 1;
            }
            ...
            if (i.getParentId() == null) {
                ...
                str.append(i.getParentId() + ",");
            }
            str.append(i.getSender() + ",");
